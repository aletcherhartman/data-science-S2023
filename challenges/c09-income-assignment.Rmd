...
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   No, the confidence intervals for each of the family sizes overlap so there is no way to confidently distinguish between them.
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   Overall lower populations have larger and more variable SE in income estimates. This could be due to increased uncertainty with small sample sizes and or with some smaller counties, such as Nantucket, having much higher levels of income inequality.
