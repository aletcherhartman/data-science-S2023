...
-   Which of `high_GPA` and `both_SAT` seems to be more strongly
    ...
    -   high_GPA has a stronger correlation, approximately 0.78,
        according to corr.test
...
-   How do the hypothesis test results compare with the results in q6?
    -   high_GPA firmly refutes our null hypothesis while the
        coefficient for both_SAT gets even closer to the null
        hypothesis.
