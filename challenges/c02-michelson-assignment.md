...
- The observations with a distinctness of three are grouped together in
  early Jun. Many of them were taken on the same day. though they are on
  the slightly lower side of velocity they still represent a wide rand.
- Comparing the plots of the original velocity data and the
  VelocityVacuum data with the + 92 attempted error correction it
  appears that the original data is closer to the actual speed of light.
  Without the +92 correction the data is much closer to the original
  uncertainty margin of 50.
...
![](c02-michelson-assignment_files/figure-gfm/unnamed-chunk-3-3.png)<!-- -->

**Observations**:

- there is no clear correlation between distinctness and temperature
- though it got slightly colder in the middle of the time frame where he
  was conducting experiments the spread of temperature values was
...
![](c02-michelson-assignment_files/figure-gfm/unnamed-chunk-4-2.png)<!-- -->
...
![](c02-michelson-assignment_files/figure-gfm/unnamed-chunk-4-3.png)<!-- -->
